...
public class FibonacciSeries {
    ...
    // To find the solutions first know what the main requirements of the programm
    ...
    public static void  FibonacciSeries(int num){
        ...
        while(First + Second <num){  // this condicition to to get the until the given number
            int Third = First + Second;
            System.out.print(Third + " "); // it used to for the iteration of the number until the contion fails
            First = Second;
            Second = Third;
            // here above swaping will perfrom to change last two number evry time
        }
